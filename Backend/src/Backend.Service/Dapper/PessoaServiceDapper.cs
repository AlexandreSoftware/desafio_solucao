...
namespace Backend.Service.Dapper; 

public interface IPessoaServiceDapper
{
    public IEnumerable<Pessoa> GetAll(int page);
    public Pessoa GetId(int id);
    public bool Post(Pessoa c);
    public int Put(Pessoa c);
    public bool Delete(int id);
}
public class PessoaServiceDapper : IPessoaServiceDapper
{
    public readonly IPessoaRepositoryDapper _PR;
    public readonly ICidadeRepositoryDapper _CR;
    public readonly IMapper _mapper;
    public PessoaServiceDapper(IPessoaRepositoryDapper pr, ICidadeRepositoryDapper cr, IMapper mapper)
    {
        _CR = cr;
        _mapper = mapper;
        _PR = pr;
    ...
    public IEnumerable<Pessoa> GetAll(int page)
    {
        string templateLog = "[Backend.Service] [PessoaServiceDapper] [GetAll]";
    ...
    public Pessoa GetId(int id)
    {
        string templateLog = "[Backend.Service] [PessoaServiceDapper] [GetId]";
    ...
    {
        string templateLog = "[Backend.Service] [PessoaServiceDapper] [Post]";
    ...
    {
        string templateLog = "[Backend.Service] [PessoaServiceDapper] [Put]";
    ...
    public bool Delete(int id)
    {
        string templateLog = "[Backend.Service] [PessoaServiceDapper] [Delete]";
