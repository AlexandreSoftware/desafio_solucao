...
{
    public interface ICidadeServiceDapper
    {
    ...
    public class CidadeServiceDapper : ICidadeServiceDapper
    {
        public readonly ICidadeRepositoryDapper _CR;
        public readonly ICidadeRepositoryRedis _CRR;
        public readonly IMapper _mapper;

        public CidadeServiceDapper(ICidadeRepositoryDapper cr, IMapper mapper, ICidadeRepositoryRedis crr)
        {
            _CRR = crr;
            _CR = cr;
            _mapper = mapper;
        ...
        public IEnumerable<Cidade> GetAll(int page)
        {
            string templateLog = "[Backend.Service] [CidadeServiceDapper] [GetAll]";
        ...
        public Cidade GetId(int id)
        {
            string templateLog = "[Backend.Service] [CidadeServiceDapper] [GetId]";
        ...
        public bool Post(Cidade c)
        {
            string templateLog = "[Backend.Service] [CidadeServiceDapper] [Post]";
        ...
        public int Put(Cidade c)
        {
            string templateLog = "[Backend.Service] [CidadeServiceDapper] [Put]";
        ...
        public bool Delete(int id)
        {
            string templateLog = "[Backend.Service] [CidadeServiceDapper] [Delete]";
